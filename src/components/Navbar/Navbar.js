    ...
    <div className="container responsive-container">
      ...
      <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul className="navbar-nav gap-4 ">
          ...
          <li className="nav-item">
            <Link className="nav-link text-dark" href="/products">Products</Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link text-dark" href="/blogs">Blog</Link>
          </li>
        </ul>
        <Link href="/contact" className="btn btn-danger rounded-pill ms-2 px-3 py-2">
          Contact Us
        </Link>
      </div>
    </div>
